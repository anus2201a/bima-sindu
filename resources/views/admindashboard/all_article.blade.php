                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-3 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h2 align="left"><b>All Article </b></h2>
                                            </div>
                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Article</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('article.add')}}" class="btn-one success text-white pt-3">Add Article</a>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $article)
                                                            <tr>
                                                                ...
                                                                <td class="col-lg-2">
                                                                    <div class="col-lg-12">
                                                                    <a href="{{route('article.update',$article->id )}}" class="btn-one success text-white pt-3">Update</a>
                                                                    <a href="{{route('article.delete', $article->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
