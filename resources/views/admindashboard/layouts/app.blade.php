...
<head>
  ...
  {{-- DataTable Link --}}
<link href="https://cdn.datatables.net/v/dt/jq-3.7.0/jszip-3.10.1/dt-2.0.1/af-2.7.0/b-3.0.0/b-colvis-3.0.0/b-html5-3.0.0/b-print-3.0.0/cr-2.0.0/date-1.5.2/fc-5.0.0/fh-4.0.0/kt-2.12.0/r-3.0.0/rg-1.5.0/rr-1.5.0/sc-2.4.0/sb-1.7.0/sp-2.3.0/sl-2.0.0/datatables.min.css" rel="stylesheet">
        ...
        <div class="admin-menu__one admin-menu__two">
          ...
          <div class="menu-bar">
            <ul class="sidebar_nav">
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.our-story')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.our-mission')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.privacy-policy')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.survivors-profile')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.contact-mental-health-expert')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                      ...
                      <div class="has-child-text has-child-text-mt">
                        <span> Contact Health Expert </span>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.journals-latest-research')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                      ...
                      <div class="has-child-text has-child-text-mt">
                        <span>  Journal Latest Research</span>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              {{-- <li class="menu-main">
                <a href="{{route('web-cms.latest-research-in-psychiatry')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                      ...
                      <div class="has-child-text has-child-text-mt">
                        <span> Latest Research in Psychiatry</span>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.top-journal-articles')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
                      ...
                      <div class="has-child-text has-child-text-mt">
                        <span> Top Journal Articles</span>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <li class="menu-main">
                <a href="{{route('web-cms.contact-us')}}">
                  <div class="has-child-main">
                    <div class="has-child-main-inner">
                      <div class="has-child-icon">
                        <span>
...
{{-- 
          ...
          <div class="admin-menu__one admin-menu__two">
            ...
            <div class="menu-bar">
              <ul class="sidebar_nav">
                <li class="menu-bar-taitel">
                  <h4>Inquiry Contacts</h4>
                </li>
                <li class="menu-main">
                  <a href="{{route('inquiry-contact.view')}}">
                    <div class="has-child-main">
                      <div class="has-child-main-inner">
                        <div class="has-child-icon mt-1">
                          <span>
              ...
              <div class="header-right">
                ...
                <div class="profile icon-dropdown" data-name="profile-drop">
                  ...
                  <div class="profile-taitel" data-name="profile-taitel ">
                    ...
                    <h6  class="text-uppercase" data-name="profile-drop">{{Auth::check() ? Auth::user()->userType : null }}
...
<script src="https://cdn.datatables.net/v/dt/jq-3.7.0/jszip-3.10.1/dt-2.0.1/af-2.7.0/b-3.0.0/b-colvis-3.0.0/b-html5-3.0.0/b-print-3.0.0/cr-2.0.0/date-1.5.2/fc-5.0.0/fh-4.0.0/kt-2.12.0/r-3.0.0/rg-1.5.0/rr-1.5.0/sc-2.4.0/sb-1.7.0/sp-2.3.0/sl-2.0.0/datatables.min.js"></script>
