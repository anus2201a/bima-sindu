                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-5 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h1 align="left"><b>Our Story Page</b></h1>
                                            </div>
                                        ...
                                        <form action="{{ route('update-cms') }}" enctype="multipart/form-data"
                                            ...
                                            <div class="personal-informations-from">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <br>
                                                                <img src="{{ asset(get_cms('banner_image', 'our_story', 'value')) }}"
                                                            ...
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text"
                                                                    value="{{ get_cms('banner_tittle', 'our_story', 'value') }}"
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value=" {!! get_cms('section_1_heading', 'our_story', 'value') !!}"
                                                                ...
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value=" {!! get_cms('section_main_tittle', 'our_story', 'value') !!}"
                                                        ...
                                                        <div class="personal-informations-from-item-inner">
                                                            <div class="row ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value=" {!! get_cms('section_1_desc_1', 'our_story', 'value') !!}"
                                                                ...
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="text"
                                                                        value=" {!! get_cms('section_1_desc_2', 'our_story', 'value') !!}"
                                                            ...
                                                            <div class="row ">
                                                                <div class="col-12 col-md-12 col-lg-6 ">
                                                                    ...
                                                                    <input type="file" name="section_1_image"
                                                                        class="form-control" aria-label="First name">
                                                                    <br>
                                                                    <img src="{{ asset(get_cms('section_1_image', 'our_story', 'value')) }}"
                                                                        style="border-radius: 12px;" width="200"
                                                                        height="auto" alt="">
                                                ...
                                                <div class="personal-informations-from-btn">
                                                    <input type="hidden" name="tag" value="our_story">
