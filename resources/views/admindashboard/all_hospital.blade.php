                                    ...
                                    <div class="col-lg-12">
                                        <div class="row border border-3 border-dark m-auto py-2">
                                            <div class="personal-informations-from-btn col-lg-6 m-auto">
                                                <h2 align="left"><b>All Hospital </b></h2>
                                            </div>
                                        ...
                                        {{-- <div class="container-fluid"> --}}
                                            <div class="card m-auto p-auto">
                                                <div class="card-header col-lg-12 d-flex justify-content-between align-items-center">
                                                    <h4 class="card-title col-lg-10">All Hospital</h4>
                                                    {{-- <button type="submit" ">Add Member</button> --}}
                                                    <a href="{{route('hospital.add')}}" class="btn-one success text-white pt-3">Add Hospital</a>
                                                </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $hospital)
                                                            <tr>
                                                                ...
                                                                <td>{{ $hospital->type }}</td>
                                                                <td>{{ $hospital->timing }}</td>
                                                                <td>{{ $hospital->description }}</td>
                                                                <td class="text-center"><img src="{{ asset($hospital->image) }}"
                                                                    style="display: block; border-radius: 10px; width: 50%%; height: 100px; object-fit: cover; margin: 0 auto;"  alt="Image"></td>
                                                                <td class="col-lg-2">
                                                                    <div class="col-lg-12">
                                                                    <a href="{{route('hospital.update',$hospital->id )}}" class="btn-one success text-white pt-3">Update</a><br>
                                                                    <a href="{{route('hospital.delete', $hospital->id)}}" class="btn-one danger bg-danger text-white pt-3">Delete</a>
                                                                </div></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
