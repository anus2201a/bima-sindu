                                        ...
                                        <form action="{{ route('update-cms') }}" enctype="multipart/form-data"
                                            ...
                                            <div class="personal-informations-from">
                                                <div class="personal-informations-from-item">
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-6 ">
                                                                ...
                                                                <br>
                                                                <img src="{{ asset(get_cms('banner_image', 'donation', 'value')) }}"
                                                            ...
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                ...
                                                                <input type="text"
                                                                    value="{{ get_cms('banner_tittle', 'donation', 'value') }}"
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Section 1 Card Tittle</label>
                                                                <input type="text"
                                                                    value="{{ get_cms('section_1_card_tittle', 'donation', 'value') }}"
                                                                    name="section_1_card_tittle" class="form-control" required
                                                                    aria-label="Last name">
                                                            </div>
                                                            <div class="col-12 col-md-12  col-lg-6">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label last-name ">Section 1 Card Description</label>
                                                                <input type="text"
                                                                    value="{{ get_cms('section_1_card_desc', 'donation', 'value') }}"
                                                                    name="section_1_card_desc" class="form-control" required
                                                                    aria-label="Last name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="personal-informations-from-item-inner">
                                                        <div class="row">
                                                            <div class="col-12 col-md-12 col-lg-6 ">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label">Banner Image</label>
                                                                <input type="file" name="section_1_card_image"
                                                                    class="form-control" aria-label="First name">
                                                                <br>
                                                                <img src="{{ asset(get_cms('section_1_card_image', 'donation', 'value')) }}"
                                                                    style="border-radius: 12px;" width="200"
                                                                    height="auto" alt="">
                                                ...
                                                <div class="personal-informations-from-btn">
                                                    <input type="hidden" name="tag" value="donation">
